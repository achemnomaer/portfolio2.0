    ...
    <>
        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0  grid place-items-center z-[100]">
            ...
            <motion.div
              ...
              ref={ref}
              className="w-full max-w-2xl  h-full md:h-fit md:max-h-[90%]  flex flex-col bg-gray-900 sm:rounded-3xl overflow-hidden"
            >
      ...
      <ul className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 items-start gap-4">
        {cards.map((card, index) => (
          ...
          >
            <BackgroundGradient className="rounded-xl p-4 bg-gray-900">
    ...
    content: () => {
      return (
        <p>
          ...
          and numerous accolades. Lana Del Rey, an iconic American
          singer-songwriter, is celebrated for her melancholic and cinematic
          music style. Born Elizabeth Woolridge Grant in New York City, she has
