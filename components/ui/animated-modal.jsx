      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "min-h-[50%] max-h-[90%] max-w-4xl bg-neutral-950 border border-neutral-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
              className
            )}
            initial={{
              opacity: 0,
...
export const ModalFooter = ({ children, className }) => {
  return (
    <div className={cn("flex justify-end p-4 bg-gray-900", className)}>
      {children}
    </div>
  );
};
...
const CloseIcon = () => {
  ...
  return (
    <button
      ...
      className="absolute top-2 right-8 group z-20"
    >
      <svg
